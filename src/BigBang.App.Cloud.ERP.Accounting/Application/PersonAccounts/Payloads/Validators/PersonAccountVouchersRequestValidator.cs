...
{
    internal class PersonAccountVouchersRequestValidator : BaseValidator<PersonAccountVouchersRequest>
    {
        public PersonAccountVouchersRequestValidator()
        {
            ...
            RuleFor(request => request.Id)
                .NotEmpty()
                .WithMessage(string.Format(Messages.Error_ShouldNotBeNull, Messages.Entity_PersonAccount));
        }
    }
}
