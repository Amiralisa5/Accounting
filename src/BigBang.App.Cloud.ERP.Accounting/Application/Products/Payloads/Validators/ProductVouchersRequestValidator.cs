...
{
    internal class ProductVouchersRequestValidator : BaseValidator<ProductVouchersRequest>
    {
        public ProductVouchersRequestValidator()
        {
            ...
            RuleFor(request => request.Id)
                .NotEmpty()
                .WithMessage(string.Format(Messages.Error_ShouldNotBeNull, Messages.Entity_Product));
        }
    }
}
